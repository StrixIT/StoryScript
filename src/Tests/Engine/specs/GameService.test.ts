...
function getService(game?, dataService?, locationService?, characterService?, combinationService?, soundService?, autoplayService?, rules?, helperService?, texts?) {
    return new GameService(dataService || {}, locationService || {}, characterService || {}, combinationService || {}, soundService || {}, autoplayService || {}, rules || {}, helperService || {}, game || {}, texts || {});
}